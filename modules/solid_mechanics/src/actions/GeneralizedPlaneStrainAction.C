...
GeneralizedPlaneStrainAction::validParams()
{
  ...
  params.addParam<bool>(
      "use_automatic_differentiation", false, "Whether to use automatic differentiation objects");
...
GeneralizedPlaneStrainAction::act()
{
  ...
  if (_current_task == "add_kernel")
  {
    ...
    const std::string scalar_k_type =
        _use_ad ? "ADGeneralizedPlaneStrain" : "GeneralizedPlaneStrain";
