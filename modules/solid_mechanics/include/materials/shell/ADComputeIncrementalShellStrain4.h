...
class ADComputeIncrementalShellStrain4 : public Material
{
public:
  static InputParameters validParams();

  ADComputeIncrementalShellStrain4(const InputParameters & parameters);
...
protected:
  ...
  ADDenseVector _soln_vector_local_5dof;
  ...
  ADMaterialProperty<RankTwoTensor> & _global_local_rotation;
  const MaterialProperty<RankTwoTensor> & _global_local_rotation_old;
