...
/**
 * ADStressDivergenceShell4 computes the stress divergence term for shell elements.
 **/

class ADStressDivergenceShell4 : public ADKernel
{
public:
  static InputParameters validParams();

  ADStressDivergenceShell4(const InputParameters & parameters);
...
protected:
  ...
  std::vector<const ADMaterialProperty<Real> *> _gamma;

  const ADMaterialProperty<RankTwoTensor> & _global_local_rotation;
